...
Selected for the [EALE](https://eale.nl/home) 2026 job market tour. [Outstanding Paper Award](https://www.eeassoc.org/news/outstanding-paper-awards-5th-virtual-discrimination-and-diversity-workshop) by EEA and Discrimination & Diversity Workshop. World Bank Development Impact [blog post](https://blogs.worldbank.org/en/impactevaluations/the-price-of-flexibility--revealing-salaries-in-job-postings--gu).  Funding: G<sup>2</sup>LM\|LIC (IZA). 
