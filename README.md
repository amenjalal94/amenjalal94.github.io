...
Natural disasters affect not only the locations they physically strike, but also surrounding areas through labour and product market linkages. As a result, the economic incidence of disasters differs from their physical footprint. We argue this in the context of Pakistan’s 2022 floods, combining an original panel of 5,100 rural households with satellite and administrative damage data, and a re-centered hydrological instrument to separately identify the impacts of direct and indirect flood exposure. On its own, direct flood exposure causes physical damage but otherwise appears to leave households largely unharmed. Accounting for indirect exposure overturns this picture. A one-standard-deviation increase in surrounding flooding raises unemployment by 7 percentage points and local food prices by 9–18%, and lowers real consumption by 16%. All else equal, direct exposure made a household more likely to receive aid, while having flooded neighbours made it less likely. To ask how disaster aid should instead be allocated, we build a spatial general-equilibrium model, and find substantial welfare gains from targeting economic incidence rather than physical damage. Ignoring indirect exposure both understates the cost of large-scale climate shocks and misallocates the assistance that follows.
...
**[Using Biometrics to Deliver Cash Payments to Women](https://documents1.worldbank.org/curated/en/099155004142238180/pdf/P1763410d1e1af00108e170e5754d04fed9.pdf).** World Bank Evidence Note 2022.

<div style="height:0.6rem;"></div>


**[Collecting Accurate Data on Intimate Partner Violence](https://documents1.worldbank.org/curated/en/099406503032591629/pdf/IDU157126b0b1079f1483d18ce317cfccf04f886.pdf).** World Bank Policy Research Paper 2025.

<div style="height:0.6rem;"></div>


**[Equilibrium Effects of a Billion Trees on Ecosystems and Livelihoods](https://www.theigc.org/blogs/billion-tree-tsunami-afforestation-pakistan).** IGC Blog 2025.<br /><br />
