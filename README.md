...
Salary is central to jobs but often hidden at the application stage, limiting workers' ability to direct search. Using firm surveys and data from Pakistan's largest online job platform, I document three new facts. First, jobs with hidden salaries offer higher pay, holding other job characteristics fixed. Second, salary hiding is driven by firm rather than job characteristics. Firms who hide are larger, and use non-disclosure as a screening tool. Third, while both men and women apply more to higher-paying jobs when salaries are visible, women no longer direct search when they are hidden, thereby self-selecting out of higher-pay opportunities. To investigate if lack of salary information imposes disproportionate costs on women's job search, I run an experiment on the job platform with 14,000 jobs and 6,354 firms, requiring treated jobs to disclose salary ranges, while control jobs retain the option to hide. The intervention modestly raises minimum advertised salaries by 3% while maximum salaries remain unchanged. Meanwhile, applications increase by 54%, driven by more interest in large firms whose higher salaries are newly revealed. This reallocation of search to large firms is 46 percentage points higher for women than men, closing baseline gender gaps in directed search. Finally, a trade-off emerges: hiding salaries modestly deters less qualified applicants, but also screens out high-ability women.
