...
Firm wage premiums can widen gender gaps in employment and pay if women face barriers to accessing high-paying firms, or negotiating the available surplus. This paper examines whether the absence of salary information in job ads restricts women’s access to high paying jobs.  I find that salaries are more likely to be hidden when higher, for otherwise comparable jobs. In particular, large firms strategically use salary non-disclosure to reduce costly screening by encouraging self-screening instead. However, this practice disadvantages women, who – like men – apply more to higher-paying jobs when salaries are visible, but – unlike men – do not direct search when they are hidden. To investigate, I conduct an experiment on Pakistan's largest job search platform involving 14,000 jobs and 6,354 firms. Treated jobs are required to disclose salary ranges, while control jobs retain the option to hide. The intervention has limited effects on advertised salaries, but increases applications by 54%, primarily due to heightened interest in large firms whose higher salaries are newly revealed. The reallocation of search from small to large firms is 37-percentage-points higher for women, fully closing existing gender gaps in sorting. While the overall applicant pool slightly declines in average quality, top applicants to treated jobs are of higher ability and 10% more likely to be female. The findings highlight a trade-off: salary non-disclosure modestly deters unqualified applicants but inadvertently screens out the highest ability women.
...
## Teaching 
<a id="teaching"></a>
- LSE PP440 Micro Economics for Master of Public Administration students (2024, 2025)
